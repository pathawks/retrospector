// References:
//   Old and new licensee code tables:
...
pub(super) fn lookup_old_licensee(code: u8) -> Option<&'static str> {
    match code {
        0x00 => Some("None"),
        0x01 => Some("Nintendo"),
        0x08 => Some("Capcom"),
...
pub fn lookup_new_licensee(code: &[u8; 2]) -> Option<&'static str> {
    match code {
        b"00" => Some("None"),
        b"01" => Some("Nintendo R&D1"),
        b"08" => Some("Capcom"),
        b"13" => Some("EA"),
